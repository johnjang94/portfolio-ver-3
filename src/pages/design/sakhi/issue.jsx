      ...
      <div className="md:mx-8 space-y-5">
        ...
        <ul className="space-y-3">
          ...
          <li className="flex space-x-2 items-start">
            ...
            <span>
              <span className="font-bold">
                None of them were able to understand the menu structure.
              </span>{" "}
          ...
          <li className="flex space-x-2 items-start">
            ...
            <span>
              <span className="font-bold">
                60% of the participants said that their willingness
              </span>{" "}
              to explore and purchase any product from the client&#39;s website{" "}
              <span className="font-bold">drops</span> when they see product
              images with inconsistent backgrounds because they do not reflect
              the branding of the client&#39;s company.
            </span>
          </li>
          <li className="flex space-x-2 items-start">
            <LuThumbsDown className="text-red-500 shrink-0" />
          ...
          <li className="flex space-x-2 items-start">
            ...
            <span>
              <span className="font-bold">
                Only 10% of the participants had good assumptions
              </span>{" "}
              that each product had connections to different holidays in India
              and that the names of the products reflect the cultural background
              in India.
            </span>
          </li>
        </ul>
